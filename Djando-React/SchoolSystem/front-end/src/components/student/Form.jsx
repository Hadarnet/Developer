...
export default class Form extends Component {
    ...
    // const data = { id_number:this.state.id_number, first_name:this.state.first_name, last_name:this.state.last_name,
    //     date_of_birth:this.state.date_of_birth, gender:this.state.gender, registration_start_date:this.state.registration_start_date,
    //     registration_end_date:this.state.registration_end_date,country_birth:this.state.country_birth,
    //     leaving_date:this.state.leaving_date, image:this.state.image  }
    ...
    return(
        <div className="form">
            <div><h2>הוסף תלמיד/ה חדש/ה</h2></div>
